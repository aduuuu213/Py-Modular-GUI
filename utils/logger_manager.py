...
from constants.config import LOG_FILE_PATH
...
class LoggerManager:
    ...
    def setup(self, ui_component=None):
        ...
        # 文件处理器
        self.file_handler = RotatingFileHandler(LOG_FILE_PATH, maxBytes=5*1024*1024, backupCount=5, encoding='utf-8')  # 设置最大文件大小为5MB，保留5个备份
